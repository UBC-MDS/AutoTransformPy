...
def test_inputs():
    with pytest.raises(TypeError):
       ...
       trans.translate("AutoTransformPy/tests/imgs/milad.jpg", "seven", 2) # Not a valid number of images
       trans.translate("AutoTransformPy/tests/imgs/milad.jpg", 6, "eight") # Not a valid translation amount

    with pytest.raises(ValueError):
        trans.translate("AutoTransformPy/tests/imgs/milad.jpg", 7, 1000) # Outside of the translation range, possible to get empty images
...
def test_return_imgs(): # Tests that the number of images returned from translate is correct
    ...
    returned_arr = trans.translate("AutoTransformPy/tests/imgs/milad.jpg", 5, 10)
