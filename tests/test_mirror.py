...
def test_inputs():
    ...
    with pytest.raises(ValueError):
        mir.mirror(fname, "h") # Not a valid string option for direction
...
def test_return_imgs(): # Tests that the number of images returned from translate is correct
    ...
    returned_arr_1a = mir.mirror(fname, "horizontal") # should return 1 image
    returned_arr_1b = mir.mirror(fname, "vertical") # should return 1 image
    returned_arr_2a = mir.mirror(fname, "all") # should return 2 images
    returned_arr_2b = mir.mirror(fname) # all is default, should return 2 images
